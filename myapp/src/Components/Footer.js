function Footer()
{
    ...
    <div class="footer-section">
            ...
            <div class="row cus-mar pt-120 pb-120 justify-content-between wow fadeInUp">
                ...
                <div class="col-xl-2 col-lg-2 col-6">
                    <div class="footer-box">
                        <h5>Support</h5>
                        <ul class="footer-link">
                            <li><a href="/cdn-cgi/l/email-protection#33404643435c41477351525d585a5c">Support@bankio</a></li>
        ...
        <div class="img-area">
            <img src="/images/footer-Illu-left.png" class="left" alt="/images"/>
            <img src="/images/footer-Illu-right.png" class="right" alt="/images"/>
        </div>
    </div>
        </>
    )
